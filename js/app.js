const translations = {
    fr: {
        ...
        "page-desc":     "VoxPresenter reconnaît votre voix et défile automatiquement au bon paragraphe. Mode miroir pour téléprompteur verre, télécommande Mac Keynote/PowerPoint, 100% hors-ligne.",
        ...
        "faq-q4": "Comment contrôler mes slides Keynote ou PowerPoint sur Mac ?",
        "faq-a4": "Téléchargez l'application gratuite VoxPresenter Remote sur votre Mac. Les deux appareils se découvrent automatiquement sur votre réseau Wi-Fi local. Chaque avancée dans votre discours change automatiquement votre diapositive sur le Mac.",
    ...
    en: {
        ...
        "page-desc":     "VoxPresenter recognizes your voice and automatically scrolls to the right paragraph. Mirror mode for beam splitter rigs, wireless Mac slide remote, 100% offline.",
        ...
        "faq-q4": "How do I control Keynote or PowerPoint slides on Mac?",
        "faq-a4": "Download the free VoxPresenter Remote companion app on your Mac. Both devices discover each other automatically over local Wi-Fi. Advancing through your script automatically advances your slides on the Mac.",
